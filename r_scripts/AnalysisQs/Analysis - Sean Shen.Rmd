...
leaguedfKR <- read_csv('../../data_sets/S13LeagueOfLegendsDataKR.csv')
leaguedfNA <- read_csv('../../data_sets/S13LeagueOfLegendsDataNA.csv')
leaguedfEUW <- read_csv('../../data_sets/S13LeagueOfLegendsDataEUW.csv')
head(leaguedf)
colnames(leaguedf)
```
