...
table <- tibble(
  NonTemporary = 0.789, Temporary = 0.726, NonTemporaryN = 4876, TemporaryN = 761, sdTemporary = 0.407, sdNonTemporary = 0.344
) %>%
