...
customlegend <- scale_fill_manual(values = c("svm_linear" = "#E06F1F", "svm_radial" = "#9D5716","ranger" = "#166D9D"),
...
(p1 + p2) / (p3 + p4) + plot_layout(guides = "collect", axis_titles = "collect") + plot_annotation(title = "Models and Mean Cross-Validated Accuracy")
```
